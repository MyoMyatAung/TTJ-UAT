...
const AudioPlayer = ({
  ...
  return (
    <div ref={containerRef} className="px-4">
      <div
        className={`${
          darkmode ? "bg-audio text-white" : "bg-audio-white text-black"
        }  rounded-lg px-3 py-2 shadow-lg space-y-2 w-full max-w-md mx-auto`}
      >
        {/* Audio Player */}
        <div className="flex items-center space-x-4">
          ...
          <button
            onClick={togglePlay}
            className="w-10 h-10 flex items-center justify-center bg-[#fe58b5] rounded-full focus:outline-none min-w-10"
          >
            {isPlaying ? (
              <svg
          ...
          <div className="flex flex-col w-full max-w-[calc(100%-60px)]">
            ...
            <div className="flex justify-center items-center py-2 pt-4">
              <input
                ...
                style={{
                  background: `linear-gradient(to right, #fe58b5 0%, #fe58b5 ${progress}%,${
                    darkmode ? "#4c4c4e" : "#4c4c4e"
                  }  ${progress}%, ${darkmode ? "#4c4c4e" : "#4c4c4e"}  100%)`,
            ...
            <div className="flex items-center mt-1 justify-between text-xs text-gray-400">
              ...
              <button
                ...
                className={`${
                  darkmode ? "bg-[#4c4c4e] text-white" : "bg-[#EEE] text-[#666]"
