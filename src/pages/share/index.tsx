...
import f11 from "../../assets/share/f12.svg";
import f22 from "../../assets/share/f22.svg";
import f33 from "../../assets/share/f33.svg";
...
const Share: React.FC<ShareProps> = ({}) => {
  ...
  return (
    <div
      className={`${
        darkmode ? "bg-[#161619]" : "bg-white/30"
      } h-screen flex flex-col p-5 gap-[1px]`}
    >
      {/* header */}
      ...
      <div
        ...
        } rounded-[8px] shadow-xl shadow-black/10`}
      >
        {/* scan */}
        <div className="">
          {invite ? (
        ...
        <div className=" pb-[20px]">
          <div className=" flex justify-around items-center">
            ...
            <div className="flex flex-col items-center gap-[1px]">
              {darkmode ? <img src={f11} alt="" /> : <img src={f1} alt="" />}
            ...
            {/* down */}
            <div className=" flex flex-col items-center gap-[1px]">
              {darkmode ? <img src={f22} alt="" /> : <img src={f2} alt="" />}
              <div className=" flex justify-center items-center gap-1">
                <span
                  className={`text-[12px] font-[400] ${
                    darkmode ? "text-white" : "text-black"
            ...
            <div className=" flex flex-col items-center gap-[1px]">
              {darkmode ? <img src={f33} alt="" /> : <img src={f3} alt="" />}
              <div className=" flex justify-center items-center gap-1">
                <span
                  className={`text-[12px] font-[400] ${
                    darkmode ? "text-white" : "text-black"
      ...
      <div className="flex justify-center items-center gap-[16px] py-8">
        ...
        <div
          ...
          className={`flex gap-[8px] justify-center items-center px-[20px] py-[16px] ${
            darkmode ? "bg-white/5" : "bg-white"
          } rounded-[24px] shadow-lg shadow-black/10`}
        >
          {darkmode ? (
            <img src={link} alt="" />
          ) : (
