...
const Header = ({ darkmode }: any) => {
  ...
  return (
    <div className="profile-header">
      {user && !isFetching ? (
        <div className={` ${darkmode ? "profile-div-main_dark" : "profile-div-main"}  w-full justify-between profile-card_point gap-[10px]`}>
          <Link
            to={"/info"}
          ...
          >
            ...
            <div className=" flex justify-center items-center gap-[8px]">
              ...
              <span className={`${darkmode ? "text-white" : "text-black"} font-[400] text-[14px]`}>
                我的积分
              </span>
            </div>
            {/* point */}
