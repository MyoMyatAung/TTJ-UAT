    ...
    <div className="profile-header">
      {user && !isFetching ? (
        <div
          ...
          }  w-full justify-between gap-[10px]`}
        >
          <Link
            to={"/info"}
          ...
          >
            ...
            <div className="pr-2">
              {darkmode ? (
                ...
                >
                  <path
                    d="M0.27465 0.3139C0.361132 0.240479 0.463868 0.182226 0.576975 0.14248C0.690082 0.102734 0.811337 0.0822754 0.933795 0.0822754C1.05625 0.0822754 1.17751 0.102734 1.29061 0.14248C1.40372 0.182226 1.50646 0.240479 1.59294 0.3139L7.78219 5.55525C7.85123 5.6136 7.90601 5.68291 7.94339 5.75921C7.98076 5.83551 8 5.91731 8 5.99991C8 6.08252 7.98076 6.16431 7.94339 6.24061C7.90601 6.31691 7.85123 6.38622 7.78219 6.44457L1.59294 11.6859C1.22799 11.995 0.6396 11.995 0.27465 11.6859C-0.0902996 11.3769 -0.0902996 10.8786 0.27465 10.5695L5.66697 5.99676L0.267203 1.42398C-0.0902987 1.12123 -0.0902996 0.61665 0.27465 0.3139Z"
                    fill="#888888"
                  />
                </svg>
              )}
          ...
          <button
            ...
            className=" flex w-full justify-between items-center pt-[12px] px-[17px]"
          >
            {/* text */}
            <div className=" flex justify-center items-center gap-[8px]">
              {darkmode ? (
                ...
                >
                  <path
                    d="M1.11085 8.16092L1.61592 9.15385C1.26808 9.4906 1.08859 9.84954 1.07746 10.2308C1.12234 10.9488 1.69723 11.5713 2.80215 12.0987C3.90708 12.6261 5.30654 12.9008 7.00054 12.9231C8.69454 12.9005 10.094 12.6256 11.1989 12.0987C12.3038 11.5718 12.8787 10.9491 12.9236 10.2308C12.9125 9.84922 12.733 9.49017 12.3852 9.15385L12.9069 8.16092C13.2548 8.45277 13.524 8.77243 13.7146 9.11992C13.9052 9.46745 14.0005 9.83769 14.0005 10.2308C13.9445 11.3414 13.2546 12.2417 11.9307 12.9317C10.6068 13.6217 8.96341 13.9777 7.00054 14C5.03731 13.9774 3.39392 13.6212 2.07038 12.9317C0.746846 12.2421 0.0568938 11.3418 0.000538423 10.2308C0.000538423 9.83802 0.0987216 9.46777 0.295077 9.11992C0.491432 8.77208 0.763 8.45241 1.11085 8.16092ZM1.11085 4.93015L1.61592 5.92308C1.26808 6.2598 1.08859 6.61877 1.07746 7C1.12234 7.71795 1.69723 8.34059 2.80215 8.86792C3.90708 9.39529 5.30654 9.67002 7.00054 9.69231C8.69454 9.66969 10.094 9.39486 11.1989 8.86792C12.3038 8.34095 12.8787 7.71831 12.9236 7C12.9125 6.61841 12.733 6.25943 12.3852 5.92308L12.9069 4.93015C13.2548 5.222 13.524 5.54166 13.7146 5.88915C13.9052 6.23664 14.0005 6.60692 14.0005 7C13.9445 8.11066 13.2546 9.01097 11.9307 9.70092C10.6068 10.3909 8.96341 10.7469 7.00054 10.7692C5.03731 10.7466 3.39392 10.3905 2.07038 9.70092C0.746846 9.01134 0.0568938 8.11103 0.000538423 7C0.000538423 6.60728 0.0987216 6.237 0.295077 5.88915C0.491432 5.54131 0.763 5.22164 1.11085 4.93015ZM7 7.53846C5.03677 7.51585 3.39338 7.15974 2.06985 6.47015C0.746308 5.78057 0.0563554 4.88026 0 3.76923C0.056 2.65857 0.745952 1.75826 2.06985 1.06831C3.39374 0.378355 5.03713 0.02226 7 0C8.96323 0.0226154 10.6066 0.378722 11.9302 1.06831C13.2537 1.75789 13.9437 2.6582 14 3.76923C13.944 4.87989 13.254 5.7802 11.9302 6.47015C10.6063 7.16011 8.96288 7.5162 7 7.53846ZM7 6.46154C8.694 6.43892 10.0935 6.16412 11.1984 5.63715C12.3033 5.11018 12.8782 4.48754 12.9231 3.76923C12.8782 3.05128 12.3033 2.42864 11.1984 1.90131C10.0935 1.37397 8.694 1.09918 7 1.07692C5.306 1.09954 3.90654 1.37434 2.80162 1.90131C1.69669 2.42828 1.1218 3.05092 1.07692 3.76923C1.1218 4.48718 1.69669 5.10982 2.80162 5.63715C3.90654 6.16449 5.306 6.43928 7 6.46154Z"
                    fill="white"
                  />
                </svg>
              ) : (
