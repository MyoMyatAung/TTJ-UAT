...
const SecQues: React.FC<SecQuesProps> = ({ setIsVisible }) => {
  ...
  const value = [
    { id: 1, name: "Your first pet name" },
    { id: 2, name: "Your favorite movie" },
        ...
        <AnimatePresence>
          ...
          >
            <div className="flex flex-col justify-center items-center gap-[16px]">
              ...
              onClick={handleBack2}
            /> */}
                <div className="p-3 cursor-pointer" onClick={handleBack}>
                  {darkmode ? (
                    <svg
                    ...
                    {showValue ? (
                      <>
                        {darkmode ? (
                          ...
                          <svg
                            ...
                            fill="none"
                          >
                            <g clip-path="url(#clip0_459_5903)">
                              <path
                                d="M7.90581 15.3508L12.4162 10.8503L16.9266 15.3508L18.3122 13.9653L12.4162 8.06933L6.52026 13.9653L7.90581 15.3508Z"
                                fill="black"
                                fill-opacity="0.6"
                              />
                            </g>
                            <defs>
                              <clipPath id="clip0_459_5903">
                                <rect
                                  width="23.5838"
                                  height="23.5838"
                                  fill="white"
                                  transform="matrix(1 0 0 -1 0.624268 23.7919)"
                                />
                              </clipPath>
                            </defs>
                          </svg>
                      ...
                      <>
                        {darkmode ? (
                          ...
                          >
                            <path
                              d="M1.90581 0.64917L6.41622 5.14975L10.9266 0.64917L12.3122 2.03472L6.41622 7.93067L0.520264 2.03472L1.90581 0.64917Z"
                              fill="black"
                              fill-opacity="0.6"
                            />
                          </svg>
