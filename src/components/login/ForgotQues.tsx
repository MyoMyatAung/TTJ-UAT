...
import CaptQues from "./forgot/CaptQues";

interface ForgotPassProps {
  setForgot: React.Dispatch<React.SetStateAction<boolean>>;
  forgot: boolean;
  parent: React.Dispatch<React.SetStateAction<boolean>>;
}

const ForgotQues: React.FC<ForgotPassProps> = ({ setForgot, parent }) => {
