...
import profileIcon from "../assets/ProfileFooter.svg";
import profileSelectedIcon from "../assets/profileSelected1.png";
import beforePostIcon from "../assets/SocialFooter.svg";
import afterPostIcon from "../assets/socialSelected1.png";
...
const Footer: FC = () => {
  ...
  return (
    <footer
      className={`bg-[#1f1f21] dark:bg-[#1f1f21] fixed  transition-all duration-300 w-full shadow-lg z-[200] bottom-0`}
    >
      <div
        className={`flex pt-4 justify-around items-center py-2  ${
          isWebClip() && "mb-5"
